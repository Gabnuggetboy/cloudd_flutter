...
class _StoryTimeTestPageState extends State<StoryTimeTestPage> {
  final String apiBaseUrl = 'http://192.168.0.103:5000';
  ...
  Future<void> _loadSelectedContents() async {
    ...
    try {
      final doc = await FirebaseFirestore.instance
          ...
          .doc("${widget.managerId}_storytime_${widget.experienceId}")
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.selectionMode ? 'Add Storytime Content' : 'Storytime Test',
        ),
